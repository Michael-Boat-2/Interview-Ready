...
namespace Examples
{
    public class DeckDisplayer : MonoBehaviour
    {
        ...
        [SerializeField] private Button playHandButton;     // The confirm button — wire this in Inspector
        [SerializeField] private TMPro.TextMeshProUGUI playHandButtonLabel; // Optional label e.g. "Play Hand (3/5)"
